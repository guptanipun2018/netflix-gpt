...
const Header=()=>{
    ...
    <div className=" absolute w-screen px-8 py-2 bg-gradient-to-b from-black z-10 flex justify-between">
        ...
        <div className="flex p-2">
            {showGptSearch &&
              (  <select className="bg-gray-700 text-white p-2 m-2" onChange={handleLanguageChange}>
            ...
            <button onClick={handleSighOut} className=" font-bold text-red-800">Sign out</button>
        </div>
        )}
    </div>
    )
